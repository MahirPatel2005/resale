  ...
  return (
    <>
      ...
      <div className="breadcrumbs">
        ...
        <span className="link" onClick={onBack}>Resale Properties</span>
        <span className="separator">&gt;</span>
        ...
        <div className="detail-title-block">
          <div>
            ...
            {launchStatus !== 'For Sale' && (
              <span className={`status-badge ${launchStatus.toLowerCase().replace(' ', '-')}`} style={{ verticalAlign: 'middle' }}>
                {launchStatus}
              </span>
            )}
          </div>
        ...
        <div>
          ...
          {activeTab === 'details' && (
            <div className="tab-content active">
              ...
              <div className="overview-section">
                ...
                {item.description ? (
                  ...
                  <div className="overview-text">
                    ...
                    <p>
                      Featuring flexible layout distributions ranging from {item.beds || 'various'} bedroom configurations, the project stands out as a flagship resale property for home buyers and property investors alike.
                    </p>
                  </div>
                )}
              </div>
              ...
              {/* Sales & Resale Transaction History Section */}
              <div className="prices-by-type-section" style={{ marginTop: '30px' }}>
                ...
                {item.history && item.history.length > 0 ? (
                  ...
                  <p style={{ color: 'var(--text-muted)', fontSize: '13px', fontStyle: 'italic' }}>
                    No recent resale transaction history recorded.
                  </p>
                )}
              </div>
            </div>
          ...
          {activeTab === 'layouts' && (
            <div className="tab-content active">
              ...
              <h3 style={{ fontSize: '18px', fontWeight: '700', color: 'var(--navy-dark)', marginBottom: '14px', fontFamily: 'Poppins, sans-serif', marginTop: '0' }}>
          ...
          <div className="listings-grid" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '20px', marginBottom: '0' }}>
            {similarProperties.map(simItem => {
              ...
              return (
                ...
                >
                  {simStatus !== 'For Sale' && (
                    <span className={`status-badge ${simStatus.toLowerCase().replace(' ', '-')}`}>
                      {simStatus}
                    </span>
                  )}
